    ...
    <div class="row row-cols-1 row-cols-md-3 mb-3 text-center">
      ...
      <div class="col">
        <div class="card mb-4 rounded-3 shadow-sm border-primary">
          ...
          <div class="card-body">
            <h1 class="card-title pricing-card-title">$
            {enterprise.map(item=>item.price)}<small class="text-body-secondary fw-light">/mo</small></h1>
            <ul class="list-unstyled mt-3 mb-4">
              <li>{enterprise.map(item=>item.user)} users included</li>
              <li>{enterprise.map(item=>item.gb)} GB of storage</li>
